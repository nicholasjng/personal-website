...
date: 2021-05-08
summary: A small hobby project about style transfer in JAX using neural networks that I have been working on for a couple of weeks.
authors: [default]
tags: [python, jax, haiku, deep-learning, gpu-computing, style-transfer]
---

*This post is a work in progress, just like the project itself! You can find the source code on [GitHub](https://github.com/nicholasjng/jax-styletransfer).*

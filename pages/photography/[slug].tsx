...
export default function PhotographyPost({ post, morePosts, preview }: PostPageType) {
...
export async function getStaticProps({ params }: Params) {
  ...
  const post = getPostBySlug(params.slug, indexItems.photo.sectionType, DEFAULT_ATTRIBUTES.concat(CONTENT_ATTRIBUTE));
